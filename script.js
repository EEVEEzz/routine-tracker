...
let EXAMPLE_TASKS = {
    ...
    2: {
        color: "#00aedb",
        label: "Dinner before 23:00"
    },
    3: {
        color: "#f37735",
        label: "Practice Ukulele"
    },
    4: {
        color: "#ffc425",
        label: "Go exercise"
...
var colorSquareChanged = (task, inputColor) => {
    ...
    currentTasks = {...currentTasks,
        [task]: {
            color: value,
            label: document.querySelectorAll("#taskLabels input[type='text']")[task].value
        }
    };
...
var taskNameChanged = (task, inputData) => {
    ...
    currentTasks = {...currentTasks,
        [task]: {
            color: colorContainers[task].style.background,
            label: value
        }
    };
